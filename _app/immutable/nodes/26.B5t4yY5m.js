import{s as xe,n as ye}from"../chunks/scheduler.B0TnBjPs.js";import{S as Pe,i as Te,e,s as l,H as k,c as ot,a as p,g as c,b as u,d as r,n as d,h as t,f as ct,o,j as s,p as i,m as lt,t as ut,k as it,l as rt}from"../chunks/index.BXVnRmkj.js";import{V as kt}from"../chunks/ViewApp.CB1BM1bD.js";function _e(Ks){let P,Ha="<code>Page</code>",mt,R,Sa="On this page you find the documentation for the <code>Page</code> class.",gt,B,Ia="Introduction",ht,N,Ma='Your app consists of different pages. One page at a time will be shown to the user, so each page has its own graphical user interface (GUI). The user can interact with the GUI in a page (for example by clicking on a <a href="/documentation/button/" title="Open the documentation for Button.">Button</a> in it). After the user has interacted with the GUI on the page, the app will take the user to the next page and show the GUI of that one instead, and so on.',ft,U,Aa="To add a page to your app, create your own class that extends the <code>Page</code> class, and override some methods there to give your own <code>Page</code> class the specific behavior you want it to have. You can name your own <code>Page</code> classes whatever you want, but they all need to have unique names within your app.",vt,m,V,ja="Example",Mn,Ga="Example showing the basic structure of a simple app.",An,wt,ne=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">MyApp</span> <span class="token keyword">extends</span> <span class="token class-name">App</span><span class="token punctuation">&#123;</span>
