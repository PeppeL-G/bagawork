import{s as fn,n as vn}from"../chunks/scheduler.B0TnBjPs.js";import{S as hn,i as mn,e as s,s as i,c as T,H as M,a as l,g as p,b as r,d as u,f as j,n as A,h as e,o,j as a,p as c,m as I,t as $,k as L,l as b}from"../chunks/index.Cnh3HYw3.js";import{V as D}from"../chunks/ViewApp.BajIxHdc.js";function Cn(on){let C,fe="BBCode",It,z,ve="On this page you find the documentation for how to style text in your BagaWork apps using BBCode.",$t,S,he='<div class="remark-container__title">Font is an alternative</div><p>BBCode is used to style smaller parts of a text. If you want to style all text in a GUI component, you&#39;re usually better of using <a href="/documentation/font/" title="Open the documentation for Font.">Font</a>.</p>',Lt,U,me="Introduction",bt,G,Ce='Various GUI components display text on the screen, such as the <a href="/documentation/text/" title="Open the documentation for Text.">Text</a> component and the <a href="/documentation/button/" title="Open the documentation for Button.">Button</a> component. That text can be styled using BBCode if you set the text with the configuration methods <code>textWithBBCode()</code> instead of <code>text()</code>.',Dt,V,we="[b] - Making text bold",zt,R,ye="To make text display as bold, surround the text with <code>[b]</code> and <code>[/b]</code>.",Ut,d,Z,_e="Example",Q,w,Pe="Open in Online Editor",mt,Gt,pn=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">StartPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
	...
	<span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`,Vt,W,Be="[i] - Making text italic",Rt,K,Ee="To make text display as italic, surround the text with <code>[i]</code> and <code>[/i]</code>.",Zt,k,N,He="Example",q,y,Oe="Open in Online Editor",Ct,Qt,rn=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">StartPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
	<span class="token function">createGui</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">&#123;</span>
		<span class="token keyword">return</span> Text<span class="token punctuation">.</span><span class="token function">textWithBBCode</span><span class="token punctuation">(</span>
		...
		<span class="token punctuation">)</span>
	<span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`,Wt,X,Se="[u] - Making text underlined",Kt,Y,Te="To make text display as underlined, surround the text with <code>[u]</code> and <code>[/u]</code>.",Nt,x,J,Me="Example",F,_,je="Open in Online Editor",wt,qt,cn=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">StartPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
	<span class="token function">createGui</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">&#123;</span>
		<span class="token keyword">return</span> Text<span class="token punctuation">.</span><span class="token function">textWithBBCode</span><span class="token punctuation">(</span>
		...
		<span class="token punctuation">)</span>
	<span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`,Xt,tt,Ae="[s] - Making text strikedhroughed",Yt,et,Ie="To make text display as strikethoughed, surround the text with <code>[s]</code> and <code>[/s]</code>.",Jt,g,nt,$e="Example",at,P,Le="Open in Online Editor",yt,Ft,un=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">StartPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
	<span class="token function">createGui</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">&#123;</span>
		<span class="token keyword">return</span> Text<span class="token punctuation">.</span><span class="token function">textWithBBCode</span><span class="token punctuation">(</span>
		...
		<span class="token punctuation">)</span>
	<span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`,te,st,be="[size] - Changing the size of the text",ee,lt,De="To change the size of the text, surround the text with <code>[size=THE_SIZE]</code> and <code>[/size]</code>, where <code>THE_SIZE</code> is the number of millimeters tall the text should be.",ne,f,ot,ze="Example",pt,B,Ue="Open in Online Editor",_t,ae,dn=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">StartPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
	<span class="token function">createGui</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">&#123;</span>
		<span class="token keyword">return</span> Text<span class="token punctuation">.</span><span class="token function">textWithBBCode</span><span class="token punctuation">(</span>
...
<span class="token punctuation">&#125;</span></code>`,ie,dt,Qe="[url] - Making text a URL",re,kt,We="To make text display as a URL the user can click on to open the webpage the URL leads to in a web browser, surround the text with <code>[url]</code> and <code>[/url]</code>.",ce,h,xt,Ke="Example",gt,H,Ne="Open in Online Editor",Bt,ue,xn=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">StartPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
	<span class="token function">createGui</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">&#123;</span>
		...
		<span class="token punctuation">)</span>
	<span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`,de,ft,qe="If you want the URL to display another text, surround the text with <code>[url=THE_URL]</code> and <code>[/url]</code>.",ke,m,vt,Xe="Example",ht,O,Ye="Open in Online Editor",Et,xe,gn=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">StartPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
	<span class="token function">createGui</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">&#123;</span>
		<span class="token keyword">return</span> Text<span class="token punctuation">.</span><span class="token function">textWithBBCode</span><span class="token punctuation">(</span>
		...
		<span class="token punctuation">)</span>
	<span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`,ge;return Q=new D({props:{project:{app:{code:`class MyApp extends App{
	createStartPage(){
		return StartPage
	}
...
}`,x:150,y:200}]}}}),gt=new D({props:{project:{app:{code:`class MyApp extends App{
	createStartPage(){
		return StartPage
	}
}`},pages:[{id:1,folderId:1,code:`class StartPage extends Page{
...
}`,x:150,y:200}]}}}),{c(){C=s("h1"),C.textContent=fe,It=i(),z=s("p"),z.textContent=ve,$t=i(),S=s("div"),S.innerHTML=he,Lt=i(),U=s("h2"),U.textContent=me,bt=i(),G=s("p"),G.innerHTML=Ce,Dt=i(),V=s("h2"),V.textContent=we,zt=i(),R=s("p"),R.innerHTML=ye,Ut=i(),d=s("div"),Z=s("div"),Z.textContent=_e,T(Q.$$.fragment),w=s("a"),w.textContent=Pe,mt=s("pre"),Gt=new M(!1),Vt=i(),W=s("h2"),W.textContent=Be,Rt=i(),K=s("p"),K.innerHTML=Ee,Zt=i(),k=s("div"),N=s("div"),N.textContent=He,T(q.$$.fragment),y=s("a"),y.textContent=Oe,Ct=s("pre"),Qt=new M(!1),Wt=i(),X=s("h2"),X.textContent=Se,Kt=i(),Y=s("p"),Y.innerHTML=Te,Nt=i(),x=s("div"),J=s("div"),J.textContent=Me,T(F.$$.fragment),_=s("a"),_.textContent=je,wt=s("pre"),qt=new M(!1),Xt=i(),tt=s("h2"),tt.textContent=Ae,Yt=i(),et=s("p"),et.innerHTML=Ie,Jt=i(),g=s("div"),nt=s("div"),nt.textContent=$e,T(at.$$.fragment),P=s("a"),P.textContent=Le,yt=s("pre"),Ft=new M(!1),te=i(),st=s("h2"),st.textContent=be,ee=i(),lt=s("p"),lt.innerHTML=De,ne=i(),f=s("div"),ot=s("div"),ot.textContent=ze,T(pt.$$.fragment),B=s("a"),B.textContent=Ue,_t=s("pre"),ae=new M(!1),se=i(),it=s("h2"),it.textContent=Ge,le=i(),rt=s("p"),rt.innerHTML=Ve,oe=i(),v=s("div"),ct=s("div"),ct.textContent=Re,T(ut.$$.fragment),E=s("a"),E.textContent=Ze,Pt=s("pre"),pe=new M(!1),ie=i(),dt=s("h2"),dt.textContent=Qe,re=i(),kt=s("p"),kt.innerHTML=We,ce=i(),h=s("div"),xt=s("div"),xt.textContent=Ke,T(gt.$$.fragment),H=s("a"),H.textContent=Ne,Bt=s("pre"),ue=new M(!1),de=i(),ft=s("p"),ft.innerHTML=qe,ke=i(),m=s("div"),vt=s("div"),vt.textContent=Xe,T(ht.$$.fragment),O=s("a"),O.textContent=Ye,Et=s("pre"),xe=new M(!1),this.h()},l(t){C=l(t,"H1",{"data-svelte-h":!0}),p(C)!=="svelte-ylq00h"&&(C.textContent=fe),It=r(t),z=l(t,"P",{"data-svelte-h":!0}),p(z)!=="svelte-xww3ag"&&(z.textContent=ve),$t=r(t),S=l(t,"DIV",{class:!0,"data-svelte-h":!0}),p(S)!=="svelte-7gj54w"&&(S.innerHTML=he),Lt=r(t),U=l(t,"H2",{"data-svelte-h":!0}),p(U)!=="svelte-1ukekoe"&&(U.textContent=me),bt=r(t),G=l(t,"P",{"data-svelte-h":!0}),p(G)!=="svelte-p3vmuu"&&(G.innerHTML=Ce),Dt=r(t),V=l(t,"H2",{"data-svelte-h":!0}),p(V)!=="svelte-zvigk0"&&(V.textContent=we),zt=r(t),R=l(t,"P",{"data-svelte-h":!0}),p(R)!=="svelte-13jqkcj"&&(R.innerHTML=ye),Ut=r(t),d=l(t,"DIV",{class:!0});var n=u(d);Z=l(n,"DIV",{class:!0,"data-svelte-h":!0}),p(Z)!=="svelte-1llzxwj"&&(Z.textContent=_e),j(Q.$$.fragment,n),w=l(n,"A",{target:!0,href:!0,title:!0,"data-svelte-h":!0}),p(w)!=="svelte-iz6z37"&&(w.textContent=Pe),mt=l(n,"PRE",{class:!0});var Je=u(mt);Gt=A(Je,!1),Je.forEach(e),n.forEach(e),Vt=r(t),W=l(t,"H2",{"data-svelte-h":!0}),p(W)!=="svelte-1y5276y"&&(W.textContent=Be),Rt=r(t),K=l(t,"P",{"data-svelte-h":!0}),p(K)!=="svelte-10w7ldy"&&(K.innerHTML=Ee),Zt=r(t),k=l(t,"DIV",{class:!0});var Ht=u(k);N=l(Ht,"DIV",{class:!0,"data-svelte-h":!0}),p(N)!=="svelte-1llzxwj"&&(N.textContent=He),j(q.$$.fragment,Ht),y=l(Ht,"A",{target:!0,href:!0,title:!0,"data-svelte-h":!0}),p(y)!=="svelte-lb50r1"&&(y.textContent=Oe),Ct=l(Ht,"PRE",{class:!0});var Fe=u(Ct);Qt=A(Fe,!1),Fe.forEach(e),Ht.forEach(e),Wt=r(t),X=l(t,"H2",{"data-svelte-h":!0}),p(X)!=="svelte-nz0xvy"&&(X.textContent=Se),Kt=r(t),Y=l(t,"P",{"data-svelte-h":!0}),p(Y)!=="svelte-14vvz32"&&(Y.innerHTML=Te),Nt=r(t),x=l(t,"DIV",{class:!0});var Ot=u(x);J=l(Ot,"DIV",{class:!0,"data-svelte-h":!0}),p(J)!=="svelte-1llzxwj"&&(J.textContent=Me),j(F.$$.fragment,Ot),_=l(Ot,"A",{target:!0,href:!0,title:!0,"data-svelte-h":!0}),p(_)!=="svelte-1ob9uvx"&&(_.textContent=je),wt=l(Ot,"PRE",{class:!0});var tn=u(wt);qt=A(tn,!1),tn.forEach(e),Ot.forEach(e),Xt=r(t),tt=l(t,"H2",{"data-svelte-h":!0}),p(tt)!=="svelte-gxnws6"&&(tt.textContent=Ae),Yt=r(t),et=l(t,"P",{"data-svelte-h":!0}),p(et)!=="svelte-1dd4dd6"&&(et.innerHTML=Ie),Jt=r(t),g=l(t,"DIV",{class:!0});var St=u(g);nt=l(St,"DIV",{class:!0,"data-svelte-h":!0}),p(nt)!=="svelte-1llzxwj"&&(nt.textContent=$e),j(at.$$.fragment,St),P=l(St,"A",{target:!0,href:!0,title:!0,"data-svelte-h":!0}),p(P)!=="svelte-10lw5un"&&(P.textContent=Le),yt=l(St,"PRE",{class:!0});var en=u(yt);Ft=A(en,!1),en.forEach(e),St.forEach(e),te=r(t),st=l(t,"H2",{"data-svelte-h":!0}),p(st)!=="svelte-1nytq7i"&&(st.textContent=be),ee=r(t),lt=l(t,"P",{"data-svelte-h":!0}),p(lt)!=="svelte-6xhjuu"&&(lt.innerHTML=De),ne=r(t),f=l(t,"DIV",{class:!0});var Tt=u(f);ot=l(Tt,"DIV",{class:!0,"data-svelte-h":!0}),p(ot)!=="svelte-1llzxwj"&&(ot.textContent=ze),j(pt.$$.fragment,Tt),B=l(Tt,"A",{target:!0,href:!0,title:!0,"data-svelte-h":!0}),p(B)!=="svelte-16luetu"&&(B.textContent=Ue),_t=l(Tt,"PRE",{class:!0});var nn=u(_t);ae=A(nn,!1),nn.forEach(e),Tt.forEach(e),se=r(t),it=l(t,"H2",{"data-svelte-h":!0}),p(it)!=="svelte-1tiusco"&&(it.textContent=Ge),le=r(t),rt=l(t,"P",{"data-svelte-h":!0}),p(rt)!=="svelte-1viqgqi"&&(rt.innerHTML=Ve),oe=r(t),v=l(t,"DIV",{class:!0});var Mt=u(v);ct=l(Mt,"DIV",{class:!0,"data-svelte-h":!0}),p(ct)!=="svelte-1llzxwj"&&(ct.textContent=Re),j(ut.$$.fragment,Mt),E=l(Mt,"A",{target:!0,href:!0,title:!0,"data-svelte-h":!0}),p(E)!=="svelte-rv4wgr"&&(E.textContent=Ze),Pt=l(Mt,"PRE",{class:!0});var an=u(Pt);pe=A(an,!1),an.forEach(e),Mt.forEach(e),ie=r(t),dt=l(t,"H2",{"data-svelte-h":!0}),p(dt)!=="svelte-oicxmm"&&(dt.textContent=Qe),re=r(t),kt=l(t,"P",{"data-svelte-h":!0}),p(kt)!=="svelte-dzldro"&&(kt.innerHTML=We),ce=r(t),h=l(t,"DIV",{class:!0});var jt=u(h);xt=l(jt,"DIV",{class:!0,"data-svelte-h":!0}),p(xt)!=="svelte-1llzxwj"&&(xt.textContent=Ke),j(gt.$$.fragment,jt),H=l(jt,"A",{target:!0,href:!0,title:!0,"data-svelte-h":!0}),p(H)!=="svelte-4408ou"&&(H.textContent=Ne),Bt=l(jt,"PRE",{class:!0});var sn=u(Bt);ue=A(sn,!1),sn.forEach(e),jt.forEach(e),de=r(t),ft=l(t,"P",{"data-svelte-h":!0}),p(ft)!=="svelte-1o8lgoj"&&(ft.innerHTML=qe),ke=r(t),m=l(t,"DIV",{class:!0});var At=u(m);vt=l(At,"DIV",{class:!0,"data-svelte-h":!0}),p(vt)!=="svelte-1llzxwj"&&(vt.textContent=Xe),j(ht.$$.fragment,At),O=l(At,"A",{target:!0,href:!0,title:!0,"data-svelte-h":!0}),p(O)!=="svelte-12yk37r"&&(O.textContent=Ye),Et=l(At,"PRE",{class:!0});var ln=u(Et);xe=A(ln,!1),ln.forEach(e),At.forEach(e),this.h()},h(){o(S,"class","remark-container tip"),o(Z,"class","remark-container__title"),o(w,"target","_blank"),o(w,"href","/editor#"),o(w,"title","Open in our Online Editor"),Gt.a=null,o(mt,"class","language-js"),o(d,"class","remark-container tip"),o(N,"class","remark-container__title"),o(y,"target","_blank"),o(y,"href","/editor#eNpdjkELwjAMhf9KyUmh6BS89CLqQT0IgoKHdbCyRVcYa+kydIz+dzsHQ72EvJeXfOlAWQuig8zkCAKyUtU1O7Ubaxm+CKu8ZqHvZCUpc6gIL6QcndUDJ9OPK8khNa5i46B3vaw8eA426BpE3IHOQSw43E2ZozsO4gc67o/gXnyR943+Z15DdEah3DQV2+0u3JsMAUnpAcvScBbrpDBPphzGc52w1jTrdMhMx085vMJDq4hDC2IZRT7xb+NSY88="),o(y,"title","Open in our Online Editor"),Qt.a=null,o(Ct,"class","language-js"),o(k,"class","remark-container tip"),o(J,"class","remark-container__title"),o(_,"target","_blank"),o(_,"href","/editor#eNpdjkELwjAMhf9KyUmh6BS89CLqQT0IgoKHdbCyRTcYa+lSdIz+dzsHQ72EvJeXfOlAGQOig0znCAKySjUNO7UbYxi+COu8YaHvZC0ps6gIL6QsndUDJ9OPK8kiOVuzcdC7XtYePAcTdAMi7qDMQSw43HWVoz0O4gc67o/gXnyR9678Z15DdEah3EoqtttduDcZApLSA1aV5ix2SaGfTFmM5y5hrXbrdMhMx085vMJDq4hDC2IZRT7xb+feY+c="),o(_,"title","Open in our Online Editor"),qt.a=null,o(wt,"class","language-js"),o(x,"class","remark-container tip"),o(nt,"class","remark-container__title"),o(P,"target","_blank"),o(P,"href","/editor#eNpdjkELwjAMhf9KyUmh6BS89CLqQT0IgoKHdbCyRTcYa2kzdIz+dzsHQ72EvJeXfOlAGQOig0znCAKySjnHTu3GGIYvwjp3LPSdrCVlFhXhhZSls3rgZPpxJVmkxtZsHPSul7UHz8EE7UDEHZQ5iAWHu65ytMdB/EDH/RHciy/yvin/mdcQnVEot5KK7XYX7k2GgKT0gFWlOYtdUugnUxbjuUtYq5t1OmSm46ccXuGhVcShBbGMIp/4N+ccY+M="),o(P,"title","Open in our Online Editor"),Ft.a=null,o(yt,"class","language-js"),o(g,"class","remark-container tip"),o(ot,"class","remark-container__title"),o(B,"target","_blank"),o(B,"href","/editor#"),o(B,"title","Open in our Online Editor"),ae.a=null,o(_t,"class","language-js"),o(f,"class","remark-container tip"),o(ct,"class","remark-container__title"),o(E,"target","_blank"),o(E,"href","/editor#"),o(E,"title","Open in our Online Editor"),pe.a=null,o(Pt,"class","language-js"),o(v,"class","remark-container tip"),o(xt,"class","remark-container__title"),o(H,"target","_blank"),o(H,"href","/editor#"),o(H,"title","Open in our Online Editor"),ue.a=null,o(Bt,"class","language-js"),o(h,"class","remark-container tip"),o(vt,"class","remark-container__title"),o(O,"target","_blank"),o(O,"href","/editor#"),o(O,"title","Open in our Online Editor"),xe.a=null,o(Et,"class","language-js"),o(m,"class","remark-container tip")},m(t,n){a(t,C,n),a(t,It,n),a(t,z,n),a(t,$t,n),a(t,S,n),a(t,Lt,n),a(t,U,n),a(t,bt,n),a(t,G,n),a(t,Dt,n),a(t,V,n),a(t,zt,n),a(t,R,n),a(t,Ut,n),a(t,d,n),c(d,Z),I(Q,d,null),c(d,w),c(d,mt),Gt.m(pn,mt),a(t,Vt,n),a(t,W,n),a(t,Rt,n),a(t,K,n),a(t,Zt,n),a(t,k,n),c(k,N),I(q,k,null),c(k,y),c(k,Ct),Qt.m(rn,Ct),a(t,Wt,n),a(t,X,n),a(t,Kt,n),a(t,Y,n),a(t,Nt,n),a(t,x,n),c(x,J),I(F,x,null),c(x,_),c(x,wt),qt.m(cn,wt),a(t,Xt,n),a(t,tt,n),a(t,Yt,n),a(t,et,n),a(t,Jt,n),a(t,g,n),c(g,nt),I(at,g,null),c(g,P),c(g,yt),Ft.m(un,yt),a(t,te,n),a(t,st,n),a(t,ee,n),a(t,lt,n),a(t,ne,n),a(t,f,n),c(f,ot),I(pt,f,null),c(f,B),c(f,_t),ae.m(dn,_t),a(t,se,n),a(t,it,n),a(t,le,n),a(t,rt,n),a(t,oe,n),a(t,v,n),c(v,ct),I(ut,v,null),c(v,E),c(v,Pt),pe.m(kn,Pt),a(t,ie,n),a(t,dt,n),a(t,re,n),a(t,kt,n),a(t,ce,n),a(t,h,n),c(h,xt),I(gt,h,null),c(h,H),c(h,Bt),ue.m(xn,Bt),a(t,de,n),a(t,ft,n),a(t,ke,n),a(t,m,n),c(m,vt),I(ht,m,null),c(m,O),c(m,Et),xe.m(gn,Et),ge=!0},p:vn,i(t){ge||($(Q.$$.fragment,t),$(q.$$.fragment,t),$(F.$$.fragment,t),$(at.$$.fragment,t),$(pt.$$.fragment,t),$(ut.$$.fragment,t),$(gt.$$.fragment,t),$(ht.$$.fragment,t),ge=!0)},o(t){L(Q.$$.fragment,t),L(q.$$.fragment,t),L(F.$$.fragment,t),L(at.$$.fragment,t),L(pt.$$.fragment,t),L(ut.$$.fragment,t),L(gt.$$.fragment,t),L(ht.$$.fragment,t),ge=!1},d(t){t&&(e(C),e(It),e(z),e($t),e(S),e(Lt),e(U),e(bt),e(G),e(Dt),e(V),e(zt),e(R),e(Ut),e(d),e(Vt),e(W),e(Rt),e(K),e(Zt),e(k),e(Wt),e(X),e(Kt),e(Y),e(Nt),e(x),e(Xt),e(tt),e(Yt),e(et),e(Jt),e(g),e(te),e(st),e(ee),e(lt),e(ne),e(f),e(se),e(it),e(le),e(rt),e(oe),e(v),e(ie),e(dt),e(re),e(kt),e(ce),e(h),e(de),e(ft),e(ke),e(m)),b(Q),b(q),b(F),b(at),b(pt),b(ut),b(gt),b(ht)}}}class Pn extends hn{constructor(C){super(),mn(this,C,null,Cn,fn,{})}}export{Pn as component};
