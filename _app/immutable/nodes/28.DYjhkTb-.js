import{s as D,n as G}from"../chunks/scheduler.DFPFbGJz.js";import{S as L,i as Y,e as o,s as M,c as Z,H as b,a as l,g as h,b as P,d as T,f as Q,n as N,h as n,o as x,j as p,p as w,m as W,t as F,k as q,l as R}from"../chunks/index.CzDE4dZi.js";import{V as X}from"../chunks/ViewApp.C2MU7-ZI.js";function $(z){let a,E="<code>Space</code>",k,r,A="On this page you find the documentation for the GUI Component <code>Space</code>.",v,i,I="Introduction",_,u,O='The <code>Space</code> component is a view whose sole purpose is to occupy space on the screen, so other children in <a href="/documentation/rows/" title="Open the documentation for Rows.">Rows</a> and <a href="/documentation/columns/" title="Open the documentation for Columns.">Columns</a> layouts are positioned where they should.',S,c,d,V="Example",m,g,s,U="Open in Online Editor",f,C,B=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">StartPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
