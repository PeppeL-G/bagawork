import{s as zs,n as $s}from"../chunks/scheduler.B0TnBjPs.js";import{S as Ds,i as Os,e as s,s as u,c as A,H as k,a as e,g as l,b as i,d as r,f as M,n as d,h as t,o,j as p,p as c,m as L,t as N,k as R,l as z}from"../chunks/index.CHfggXAQ.js";import{V as $}from"../chunks/ViewApp.6tllL5xD.js";function Vs(xs){let b,oa="<code>EnterNumber</code>",ot,V,la="On this page you find the documentation for the GUI Component <code>EnterNumber</code>.",lt,q,ca="Introduction",ct,B,ua="The <code>EnterNumber</code> component is a view in which the user can enter a number. If the user presses the Enter key (<code>↵</code>) in the component, the app will progress to the next page.",ut,x,X,ia="Example",Mn,ra="In this example, the GUI consists of only the <code>EnterNumber</code> component, so it covers the entire screen.",K,E,ka="Open in Online Editor",Ln,it,vs=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">StartPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
