import{s as de,n as ge}from"../chunks/scheduler.B0TnBjPs.js";import{S as me,i as he,e,s as l,H as k,c as at,a as p,g as c,b as u,d as r,n as d,h as t,f as st,o,j as s,p as i,m as et,t as pt,k as ot,l as ct}from"../chunks/index.Cnh3HYw3.js";import{V as lt}from"../chunks/ViewApp.9sx5twVU.js";function fe(Qs){let y,Ta="<code>Page</code>",ut,R,ba="On this page you find the documentation for the <code>Page</code> class.",it,O,Ca="Introduction",rt,D,Ea="Your app consists of different pages. One page at a time will be shown to the user, so each page has its own graphical user interface (GUI). The user can interact with the GUI in a page (for example by clicking on a button in it). After the user has interacted with the GUI on the page, the app will take the user to the next page and show the GUI of that one instead, and so on.",kt,B,Ia="To add a page to your app, create your own class that extends the <code>Page</code> class, and override some methods there to give your own <code>Page</code> class the specific behavior you want it to have. You can name your own <code>Page</code> classes whatever you want, but they need to have unique names within your app.",dt,g,U,Ha="Example",In,La="Example showing the basic structure of a simple app.",Hn,gt,Ws=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">MyApp</span> <span class="token keyword">extends</span> <span class="token class-name">App</span><span class="token punctuation">&#123;</span>
