import{s as F,n as $}from"../chunks/scheduler.B0TnBjPs.js";import{S as z,i as Y,e as p,s as X,c as nn,H as w,a as e,g as P,b as Z,d as k,f as sn,n as x,h as t,o as u,j as T,m as an,p as r,t as tn,k as pn,l as en}from"../chunks/index.Cnh3HYw3.js";import{V as on}from"../chunks/ViewApp.BajIxHdc.js";function cn(V){let o,_="21 Sticks",b,l,G="This example shows how to create an app where the user plays the game 21 sticks against the computer.",y,a,i,c,W="Open in Online Editor",m,O,q=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">MyApp</span> <span class="token keyword">extends</span> <span class="token class-name">App</span><span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`,h,j,H=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">PlayerWon</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
	<span class="token function">createGui</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">&#123;</span>
		...
		<span class="token punctuation">)</span>
	<span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`,M;return i=new on({props:{project:{app:{code:`class MyApp extends App{
