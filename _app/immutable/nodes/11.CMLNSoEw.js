...
<span class="token punctuation">&#125;</span></code>`,Dn,A,vt="<code>text()</code> - Setting styled text",Gn,D,Ct='Use the configuration method <code>textWithBBCode()</code> to tell the <code>Text</code> component which text it should show on the screen and that also can be styled with <a href="/documentation/bbcode/" title="Open the documentation for bbcode.">bbcode</a> tags. Pass the text as a string. The text will always be centered in the <code>Button</code>.',Nn,g,G,wt="Example",N,w,_t="Open in Online Editor",gn,Vn,Jt=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">StartPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
	...
	<span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`,zn,V,Pt="<code>page()</code> - Going to another page",qn,z,yt="Use the configuration method <code>page()</code> to tell the <code>Button</code> component which page the user should come to when clicking on the button. Pass the page as an argument.",Rn,q,Tt="If this method is not used, then the current page will be reloaded when the user clicks on the button.",Wn,k,R,bt="Example",W,_,Bt="Open in Online Editor",fn,Un,Qt=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">StartPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
	<span class="token function">createGui</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">&#123;</span>
