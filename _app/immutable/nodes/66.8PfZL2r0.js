import{s as Ha,n as Ia}from"../chunks/scheduler.UQwd20JU.js";import{S as Oa,i as Ga,e as s,s as c,c as C,H as y,a as p,g as o,b as u,d as r,f as b,n as S,h as n,o as l,j as a,p as i,m as B,t as A,k as L,l as T}from"../chunks/index.i__Fl8cY.js";import{V as E}from"../chunks/ViewApp.m6vzcyjb.js";function ja(ya){let d,he="4. Paper",tn,U,me="This tutorial will teach you how to use the <code>Paper</code> component to draw images in your app yourself.",nn,D,xe="Introduction",en,V,ve="The <code>Paper</code> component is a view that you can draw whatever you want on yourself, so it&#39;s similar to the <code>Image</code> component, but instead of specifying the URL of the image, you specify how the image should be drawn using lines, circles, rectangles, etc.",an,K,we="Creating a <code>Paper</code> component instance",sn,Y,Pe="To create a new <code>Paper</code> component, simply write <code>Paper</code>.",pn,M,N,Ce="Example",W,J,k,ye="Open in Online Editor",Nt,on,ba=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">StartPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
