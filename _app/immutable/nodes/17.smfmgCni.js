import{s as fa,n as xa}from"../chunks/scheduler.UQwd20JU.js";import{S as ha,i as va,e as a,s as u,c as wt,H as k,a as e,g as l,b as i,d as r,f as Et,n as d,h as n,o,j as p,p as c,m as Tt,t as yt,k as Ct,l as _t}from"../chunks/index.i__Fl8cY.js";import{V as It}from"../chunks/ViewApp.m6vzcyjb.js";function Pa(pa){let m,hn="<code>EnterText</code>",St,M,vn="On this page you find the documentation for the GUI Component <code>EnterText</code>.",Mt,j,Pn="Introduction",jt,b,wn="The <code>EnterText</code> component is a view in which the user can enter some text. If the user presses the Enter key (<code>↵</code>) in the component, the app will progress to the next page.",bt,g,H,En="Example",ct,Tn="In this example, the GUI consists of only the <code>EnterText</code> component, so it covers the entire screen.",L,V,f,yn="Open in Online Editor",ut,Ht,oa=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">StartPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
	<span class="token function">createGui</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">&#123;</span>
		<span class="token keyword">return</span> EnterText
	<span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`,Lt,N,Cn="<code>text()</code> - Setting an initial text",Vt,G,_n="Use the configuration method <code>text()</code> to give the <code>EnterText</code> an initial text it should contain contain initially. Pass the text as a string.",Nt,y,O,In="Example",A,z,x,Sn="Open in Online Editor",it,Gt,la=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">StartPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
	<span class="token function">createGui</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`,gt,tn,ka=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">GreetingPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
	<span class="token function">createGui</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">&#123;</span>
		...
		<span class="token punctuation">)</span>
	<span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`,nn,st,Un="<code>handler()</code> - Handling the entered name",an,pt,$n="Use the configuration method <code>handler()</code> to tell the <code>EnterText</code> component which method to call to handle the entered text. The method will be passed the entered text as an argument.",en,S,ot,Fn="Example",E,lt,T,Jn="Open in Online Editor",ft,sn,da=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">MyApp</span> <span class="token keyword">extends</span> <span class="token class-name">App</span><span class="token punctuation">&#123;</span>
