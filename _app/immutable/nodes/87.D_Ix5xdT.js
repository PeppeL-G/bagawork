import{s as Qn,n as On}from"../chunks/scheduler.B0TnBjPs.js";import{S as Wn,i as qn,e,s as l,H as w,c as Ut,a as p,g as o,b as u,d,n as C,h as n,f as Qt,o as c,j as s,p as i,m as Ot,t as Wt,k as qt,l as Kt}from"../chunks/index.BXVnRmkj.js";import{V as Dt}from"../chunks/ViewApp.CB1BM1bD.js";function Kn(jn){let h,Jt="4. App Variables and Methods",it,P,Xt="This tutorial will teach you what app variables and app methods are in BagaWork, and how they differ from page variables and page methods.",rt,b,zt="Why app variables are needed",kt,_,Yt="A page variable can only be accessed and used on the page the created it. But often, we need to be able to use the same variable on many different pages. For these cases, we can instead use an app variable.",dt,T,Ft="How to create app variables",mt,A,Zt="To create an app variable, we write the same code as for creating an app constant, but we use <code>thisNamingConvention</code> for app variables instead of <code>THIS_NAMING_CONVENTION</code> (which is only used for constants).",gt,B,tn="In the code below you find an example of how to create the following app variables:",ht,N,nn="<li><code>name</code> will have the string value <code>Alice</code></li> <li><code>lastVisit</code> will have the string value <code>2023-09-16</code></li>",ft,E,xt,Hn=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">MyApp</span> <span class="token keyword">extends</span> <span class="token class-name">App</span><span class="token punctuation">&#123;</span>
