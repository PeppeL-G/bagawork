import{s as Et,n as jt}from"../chunks/scheduler.DFPFbGJz.js";import{S as qt,i as At,e as a,s as l,H as Mt,c as $t,a as o,g as p,b as c,d as $,n as bt,h as e,f as Rt,o as q,j as s,p as S,m as Vt,t as Gt,k as zt,l as Dt}from"../chunks/index.CzDE4dZi.js";import{V as Ut}from"../chunks/ViewApp.C2MU7-ZI.js";function Ot(St){let u,ot="<code>Paper</code>",R,d,pt="On this page you find the documentation for the GUI Component <code>Paper</code>.",V,k,lt="Introduction",G,m,ct="The <code>Paper</code> component is a view that you yourself specify what it should look like by drawing on it. The component also supports redrawing itself multiple times per second (without the user leaving the page), so it&#39;s a perfect view for visualizing games!",z,i,h,it="Example",I,ut="Example showing what the <code>Paper</code> component can look like when shown on the screen.",B,D,It=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">StartPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
