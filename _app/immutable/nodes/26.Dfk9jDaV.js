import{s as xe,n as ye}from"../chunks/scheduler.B0TnBjPs.js";import{S as Pe,i as Te,e,s as l,H as k,c as ot,a as p,g as c,b as u,d as r,n as d,h as t,f as ct,o,j as s,p as i,m as lt,t as ut,k as it,l as rt}from"../chunks/index.Cnh3HYw3.js";import{V as kt}from"../chunks/ViewApp.BajIxHdc.js";function _e(Ks){let P,Ha="<code>Page</code>",mt,R,Ia="On this page you find the documentation for the <code>Page</code> class.",gt,B,Ma="Introduction",ht,N,Sa='Your app consists of different pages. One page at a time will be shown to the user, so each page has its own graphical user interface (GUI). The user can interact with the GUI in a page (for example by clicking on a <a href="/documentation/button/" title="Open the documentation for Button.">Button</a> in it). After the user has interacted with the GUI on the page, the app will take the user to the next page and show the GUI of that one instead, and so on.',ft,U,Aa="To add a page to your app, create your own class that extends the <code>Page</code> class, and override some methods there to give your own <code>Page</code> class the specific behavior you want it to have. You can name your own <code>Page</code> classes whatever you want, but they all need to have unique names within your app.",vt,m,V,ja="Example",Sn,Ga="Example showing the basic structure of a simple app.",An,wt,ne=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">MyApp</span> <span class="token keyword">extends</span> <span class="token class-name">App</span><span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`,Ht,M,Ya='<div class="remark-container__title">The &quot;a&quot; variable</div><p>In your <code>Page</code> classes, you can also use the special BagaWork variable <a href="/documentation/a/" title="Open the documentation for a.">a</a> to access the things you have in your <a href="/documentation/app/" title="Open the documentation for App.">App</a> class. For more information, see the documentation for the <a href="/documentation/app/" title="Open the documentation for App.">App</a> class.</p>',It,W,$a="<code>createBeforeDirections()</code> - Redirecting the user to another page",Mt,J,za='The method <code>createBeforeDirections()</code> will be called directly when the user comes to the page. In it, you can return an array of <a href="/documentation/direction/" title="Open the documentation for Direction.">Direction</a> objects. If there exists a <code>Direction</code> object that has <code>when()</code> set to <code>true</code>, the user will immediately be taken to that page, and will never see the GUI of this page (no other methods on this page will be called, not even <code>onBefore()</code>).',St,g,q,Fa="Example",X,T,Wa="Open in Online Editor",Nn,At,pe=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">StartPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`,Pa,bn,Es="<code>onUpdate()</code> - Updating the state of the page",Ta,Cn,Hs="When the user starts running a new version of your app with a page state from an older version of the app, <code>Page.onUpdate()</code> will be called. In it, you can implement your own custom update logic if you want.",_a,Ln,Is="<code>onUpdate()</code> will be passed two values:",ba,En,Ms="<li><code>oldP</code>, which contains the stored page variables</li> <li><code>oldVersion</code>, which contains the old version number of the app the user ran before</li>",Ca,Hn,Ss='For more information, see <a href="/documentation/state/" title="Open the documentation for State.">State</a>.',La;return X=new kt({props:{project:{app:{code:`class MyApp extends App{
	createStartPage(){
		return StartPage
	}
