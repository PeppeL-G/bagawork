import{s as se,n as ee}from"../chunks/scheduler.DFPFbGJz.js";import{S as pe,i as oe,e as s,s as l,H as k,c as $n,a as e,g as c,b as u,d as r,n as d,h as t,f as nt,o,j as p,p as i,m as tt,t as at,k as st,l as et}from"../chunks/index.CzDE4dZi.js";import{V as pt}from"../chunks/ViewApp.C2MU7-ZI.js";function ce(js){let h,Pa="<code>Page</code>",ot,O,Ta="On this page you find the documentation for the <code>Page</code> class.",ct,V,_a="Introduction",lt,N,ba="Your app consists of different pages. One page at a time will be shown to the user, so each page has its own graphical user interface (GUI). The user can interact with the GUI in a page (for example by clicking on a button in it). After the user has interacted with the GUI on the page, the app will take the user to the next page and show the GUI of that one instead, and so on.",ut,U,Sa="To add a page to your app, create your own class that extends the <code>Page</code> class, and override some methods there to give your own <code>Page</code> class the specific behavior you want it to have. You can name your own <code>Page</code> classes whatever you want, but they need to have unique names within your app.",it,g,z,Ca="Example",Cn,Ba="Example showing the basic structure of a simple app.",Bn,rt,Ds=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">MyApp</span> <span class="token keyword">extends</span> <span class="token class-name">App</span><span class="token punctuation">&#123;</span>
