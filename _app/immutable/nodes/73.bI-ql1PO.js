import{s as Te,n as ye}from"../chunks/scheduler.B0TnBjPs.js";import{S as Ce,i as Ge,e as a,s as c,c as at,H as Mt,a as s,g as p,b as i,d as g,f as st,n as At,h as e,o as r,j as o,p as l,m as ot,t as pt,k as lt,l as ct}from"../chunks/index.Cnh3HYw3.js";import{V as it}from"../chunks/ViewApp.BajIxHdc.js";function Ie(fe){let k,$t="5. Changing Page",dt,w,Lt="This tutorial will teach you how to take the user to another page when she interacts with the GUI on the page currently shown to them.",ht,P,Vt="Multiple pages",gt,T,Wt="An app who's GUI always look the same is usually not that fun. Therefore, most BagaWork apps consists of multiple different pages, and when we want to change the GUI shown to the user in the app, we simply take the user to another page in the app, and show the GUI of that page instead. Simple as that!",kt,y,Qt="Going to another page",xt,C,zt="To take the user to another page in the app, the user usually needs to interact with the GUI on the page somehow. The simplest example of this is by clicking on a button. For that purpose, BagaWork has the <code>Button</code> component.",ft,G,qt="To tell the <code>Button</code> which text it should display, use the configuration method <code>text()</code>, and pass it the text it should contain as a string.",mt,u,I,Dt="Example",q,Xt="Example of how to show a <code>Button</code> on a page (note: nothing special should happen when you click on the button in this example).",_,x,Nt="Open in Online Editor",D,vt,me=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">StartPage</span> <span class="token keyword">extends</span> <span class="token class-name">Page</span><span class="token punctuation">&#123;</span>
